      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-text-secondary">
            Your previously generated content, ready to copy and use
          </p>
        </div>
        ...
        {history.length === 0 ? (
          ...
          <div className="max-w-6xl mx-auto space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-2xl font-bold text-text-primary">Your Content</h2>
                <p className="text-text-secondary">Recently generated posts and stories</p>
              </div>
